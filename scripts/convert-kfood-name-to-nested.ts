/**
 * kfood_brands 컬렉션의 name을 name 서브 도큐먼트로 변환
 * 
 * 사용법: npx tsx scripts/convert-kfood-name-to-nested.ts
 * 
 * 기존: { name: "..." }
...
async function main() {
  ...
  try {
    ...
    const collection = db.collection('kfood_brands')

    console.log(`DB: ${DB_NAME} / 컬렉션: kfood_brands\n`)
